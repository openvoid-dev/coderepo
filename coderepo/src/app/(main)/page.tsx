    ...
    <>
      ...
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="container flex max-w-[74rem] flex-col items-center gap-4 text-center">
          <h1 className="font-heading text-3xl sm:text-5xl md:text-6xl lg:text-7xl dark:text-red-100">
      ...
      {/* Example Projects */}
      <section className="container space-y-6 bg-red-100 py-8 dark:bg-neutral-950/50 md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          <h1 className="font-heading text-3xl leading-[1.1] sm:text-3xl md:text-6xl dark:text-red-100">
      ...
      {/* Open Source */}
      <section className="container py-8 md:py-12 lg:py-24 bg-red-100 dark:bg-neutral-950/50">
