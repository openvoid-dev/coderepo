...
export default function IndexPage() {
  return (
    <>
      ...
      {/* Example Projects */}
      <section className="container space-y-6 bg-emerald-50 py-8 dark:bg-emerald-900/10 md:py-12 lg:py-24">
      ...
      {/* Open Source */}
      <section className="container py-8 md:py-12 lg:py-24 bg-emerald-50 dark:bg-emerald-900/10">
