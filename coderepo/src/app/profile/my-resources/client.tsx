...
interface MyResourcesProfilePageClientProps {
    initialResourcesData: Awaited<ReturnType<(typeof serverClient.user.getSavedResources.query)>>;
}

export default function MyResourcesProfilePageClient({ initialResourcesData }: MyResourcesProfilePageClientProps) {
